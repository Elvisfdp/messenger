<template>
    <b-container fluid style="height: calc(100vh - 116px); padding-left:0px;padding-right:0px;">
    <b-row class="h-100" style="margin-bottom: 30px;
    margin-block-start: 30px;margin-left: 30px;
    margin-right: 30px;">
        ...
        <b-col cols="3" style="background:rgb(27, 26, 26);">
            ...
            <contact-list-paciente-component v-on:conversationSelected="changeActiveConversation($event)"
            :conversations="conversationsFiltered">
            </contact-list-paciente-component>
            <div id="bottom-bar">
        ...
        methods:{
           ...
           getMessages(){
            ...
            addMessage(message){
             ...
             getConversations(){
                axios.get('/api/conversationsPacientes')
                .then((response)=>{
            ...
            datosModal(){
                axios.get('/api/notconversationsPaciente')
                .then((response)=>{
